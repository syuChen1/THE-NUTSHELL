...
#line 102 "nutshparser.tab.c" /* yacc.c:339  */
...
#line 37 "nutshparser.y" /* yacc.c:355  */

#include "nutshell.h"

#line 136 "nutshparser.tab.c" /* yacc.c:355  */
...
#line 195 "nutshparser.tab.c" /* yacc.c:355  */
};
...
#line 212 "nutshparser.tab.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "NON_BUILD_IN_COMMAND", "':'", "$accept", "PATH_INPUT", "COMBINE_INPUT",
  "CMD", "COMMAND_LIST", "COMMAND", "input", YY_NULLPTR
};
#endif
...
{
      -3,     6,     9,   -21,    10,    11,    12,   -21,    13,    14,
      15,   -21,   -21,    20,   -21,   -21,    16,   -21,    -1,   -21,
     -21,    18,   -21,   -21,   -21,    17,    19,   -21,   -21,    -1,
      21,   -21,    -1,   -21
};
...
{
       6,     0,     9,     5,    11,     0,     0,    14,     0,    17,
       0,     4,     7,     0,     2,     8,     0,    12,     0,    15,
      18,    16,     3,     1,    10,    22,     0,    13,    19,     0,
       0,    21,     0,    20
};
...
{
       1,     2,     3,     4,    25,     5,     6,     7,     8,    31,
       9,    26,    33,    14,    15,    16,    17,    18,    19,    20,
      23,    24,    22,    28,    30,     0,     0,     0,     0,     0,
       0,    29,     0,     0,     0,    32
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     5,     8,     9,    10,    11,    29,
      13,    12,    32,     7,     5,     5,     5,     5,     5,     5,
       0,     5,     7,     5,     5,    -1,    -1,    -1,    -1,    -1,
      -1,    14,    -1,    -1,    -1,    14
};
...
static const yytype_uint8 yystos[] =
{
      ...
      18,    19,    20,    21,     7,     5,     5,     5,     5,     5,
       5,    17,     7,     0,     5,     5,    12,    16,     5,    14,
       5,    16,    14,    16
};
...
#line 53 "nutshparser.y" /* yacc.c:1646  */
    {exit(1); return 1; }
#line 1302 "nutshparser.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 54 "nutshparser.y" /* yacc.c:1646  */
    { cmdTable = (*(Cmd_t*)(&yyvsp[-1])); finalCall(cmdTable); return 1;}
#line 1308 "nutshparser.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 57 "nutshparser.y" /* yacc.c:1646  */
    {(*(Cmd_t*)(&yyval)) = make_Cmd_object((*(std::vector<Command_t>**)(&yyvsp[0])), {});}
#line 1314 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 1320 "nutshparser.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 61 "nutshparser.y" /* yacc.c:1646  */
    { (*(std::vector<Command_t>**)(&yyval)) = new std::vector<Command_t>(); }
#line 1326 "nutshparser.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 62 "nutshparser.y" /* yacc.c:1646  */
    { (*(std::vector<Command_t>**)(&yyval)) = new std::vector<Command_t>(); (*(std::vector<Command_t>**)(&yyval))->push_back((*(Command_t*)(&yyvsp[0]))); }
#line 1332 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 1351 "nutshparser.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 69 "nutshparser.y" /* yacc.c:1646  */
    {vector<string> args; args.push_back("hello"); (*(Command_t*)(&yyval)) = make_Command_object(*(*(std::string**)(&yyvsp[0])), args, *(*(std::string**)(&yyvsp[0])), "STDOUT", 0, true);}
#line 1357 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 1381 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 1393 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 1399 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 1405 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 87 "nutshparser.y" /* yacc.c:1906  */
