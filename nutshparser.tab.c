...
#line 154 "nutshparser.tab.c" /* yacc.c:355  */
};
...
#line 171 "nutshparser.tab.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "UNALIAS", "SETENV", "PRINTENV", "UNSETENV", "META", "PATH", "$accept",
...
{
      -3,     7,     5,    -1,     6,    10,    11,    12,    13,    -4,
      17,    -4,    14,    -4,    -1,    15,    18,    -4,    19,    20,
      -4,    21,    -4,    -4,    -4,    -4,    22,    -4,    -4,    23,
      -4,    -4,    -4
};
...
#line 40 "nutshparser.y" /* yacc.c:1646  */
    {exit(1); return 1; }
#line 1257 "nutshparser.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 41 "nutshparser.y" /* yacc.c:1646  */
    {runCD((yyvsp[-1].string)); return 1; }
#line 1263 "nutshparser.tab.c" /* yacc.c:1646  */
    break;
...
#line 57 "nutshparser.y" /* yacc.c:1646  */
    {if((yyvsp[0].string)[0] == '.') (yyval.string) = pathInput((yyvsp[0].string)); else (yyval.string) = (yyvsp[0].string);}
...
#line 58 "nutshparser.y" /* yacc.c:1906  */
